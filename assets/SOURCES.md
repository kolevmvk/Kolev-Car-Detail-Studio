...
| `public/story/car-key-handover.jpg` | first owner / key handover memory | Negative Space | https://www.pexels.com/photo/person-in-grey-shirt-handing-keys-97079/ |
| `public/story/businessman-car-work.jpg` | business-use memory inside a vehicle | Lara Jameson | https://www.pexels.com/photo/businessman-talking-on-phone-while-looking-at-his-laptop-9623688/ |
| `public/story/night-couple-drive.jpg` | restrained night/couple memory inside a car | Ana Karolina Pereira | https://www.pexels.com/photo/people-inside-vehicle-5958360/ |
| `public/story/child-back-seat.jpg` | child detail for the family-trip chapter | Héctor Herrera Delgado | https://www.pexels.com/photo/young-girl-with-braids-in-the-backseat-36081572/ |
| `public/story/moving-car-boxes.jpg` | moving-day boxes being unloaded from a car | Ketut Subiyanto | https://www.pexels.com/photo/happy-couple-unloading-automobile-while-moving-apartment-in-summer-day-4246266/ |
...
The deployable files in `public/video/` are web derivatives encoded without audio at 24 fps: horizontal clips at 1280×720 and the vertical foam clip at 720×1280. Original source provenance remains the Pexels items above.

## Owner-generated campaign imagery — DreamArtGen

The following WebP files were generated by the project owner on 19 August
2026 and supplied explicitly for this campaign. They form an authored fictional
visual series around the same grey Golf and recurring female protagonist; they
must not be represented as customer documentation or proof of a completed job.

- `public/story/kolev-hero-coast.webp`
- `public/story/owner-arrival.webp`
- `public/story/owner-business-drive.webp`
- `public/story/night-couple.webp`
- `public/story/family-road-trip.webp`
- `public/story/moving-day.webp`
- `public/story/headlight-inspection.webp`
- `public/story/headlight-before.webp`
- `public/story/headlight-after.webp`
- `public/story/studio-detailer.webp`
- `public/story/polisher-transparent.webp`
- `public/story/campaign-finale.webp`
- `public/story/tr-1.webp` … `public/story/tr-6.webp` — studio transformation sequence for “Skidamo godine”
- `public/story/tr-x.webp` — owner close-up for the public price scene

The headlight pair is used only as an explicitly labelled **authored
visualization**. The source PNGs remain in `assets/images/`; deployable WebP
derivatives were encoded locally. The supplied landscape glamour image is used
only as a clearly separated branded epilogue, not as continuation of the Golf
story. One portrait glamour image featuring another vehicle remains excluded.
